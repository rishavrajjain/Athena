...
export default function SendGiftCardPage(props) {
    ...
    const sendGiftCard = async(e)=>{
        ...
        try{
            const result = await axios.post(`${process.env.REACT_APP_API_BASE_URL}/api/send-gift-card/${page}/init`,{
                name,
                email,
                code:id,
                amount:amount
    ...
    <div class="form-panel one">
      ...
      <div class="form-content">
        ...
        <div class="form-group"><label for="name">Your Name</label><input onChange={onChange} type="text" id="name" name="name" required="required" /></div>
          <div class="form-group"><label for="email">Your Email</label><input onChange={onChange} type="text" id="email" name="email" required="required" /></div>
